...
******************************************************************************
* File Name    : R_PG_Timer_MTU_U0_C7.c
* Version      : 1.00
* Device(s)    : 
* Tool-Chain   : 
* H/W Platform : 
...
* Limitations  : 
******************************************************************************
* History : 13.06.2013 Version Description
*         :   
******************************************************************************/
...
******************************************************************************/
#include "R_PG_Timer_MTU_U0_C7.h"
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_Set_MTU_U0_C7(void)
*
* Function Name: R_PG_Timer_Set_MTU_U0_C7
*
...
******************************************************************************/
bool R_PG_Timer_Set_MTU_U0_C7(void)
{
	...
	create_params.data3 = PDL_MTU3_CLK_ICLK_DIV_64 | PDL_MTU3_CLK_RISING | PDL_MTU3_CLEAR_TGRB;
	create_params.data6 = PDL_MTU3_A_OC_HIGH_CM_LOW | PDL_MTU3_B_OC_LOW_CM_HIGH;
	create_params.data7 = PDL_MTU3_C_OC_HIGH_CM_LOW | PDL_MTU3_D_OC_LOW_CM_HIGH;
	create_params.data10 = 1875;
	create_params.data11 = 24999;
	create_params.data12 = 1875;
	create_params.data13 = 24999;
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_StartCount_MTU_U0_C7(void)
*
* Function Name: R_PG_Timer_StartCount_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_StartCount_MTU_U0_C7(void)
{
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_HaltCount_MTU_U0_C7(void)
*
* Function Name: R_PG_Timer_HaltCount_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_HaltCount_MTU_U0_C7(void)
{
	R_MTU3_ControlChannel_structure parameters;
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_GetCounterValue_MTU_U0_C7(uint16_t * counter_val)
*
* Function Name: R_PG_Timer_GetCounterValue_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_GetCounterValue_MTU_U0_C7(uint16_t * counter_val)
{
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_SetCounterValue_MTU_U0_C7(uint16_t counter_val)
*
* Function Name: R_PG_Timer_SetCounterValue_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_SetCounterValue_MTU_U0_C7(uint16_t counter_val)
{
	R_MTU3_ControlChannel_structure parameters;
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_GetTGR_MTU_U0_C7(uint16_t * tgr_a_val, uint16_t * tgr_b_val, uint16_t * tgr_c_val, uint16_t * tgr_d_val, uint16_t * tgr_e_val, uint16_t * tgr_f_val)
*
* Function Name: R_PG_Timer_GetTGR_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_GetTGR_MTU_U0_C7(uint16_t * tgr_a_val, uint16_t * tgr_b_val, uint16_t * tgr_c_val, uint16_t * tgr_d_val, uint16_t * tgr_e_val, uint16_t * tgr_f_val)
{
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_SetTGR_A_MTU_U0_C7(uint16_t tgr_a_val)
*
* Function Name: R_PG_Timer_SetTGR_A_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_SetTGR_A_MTU_U0_C7(uint16_t tgr_a_val)
{
	R_MTU3_ControlChannel_structure parameters;
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_SetTGR_B_MTU_U0_C7(uint16_t tgr_b_val)
*
* Function Name: R_PG_Timer_SetTGR_B_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_SetTGR_B_MTU_U0_C7(uint16_t tgr_b_val)
{
	R_MTU3_ControlChannel_structure parameters;
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_SetTGR_C_MTU_U0_C7(uint16_t tgr_c_val)
*
* Function Name: R_PG_Timer_SetTGR_C_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_SetTGR_C_MTU_U0_C7(uint16_t tgr_c_val)
{
	R_MTU3_ControlChannel_structure parameters;
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_SetTGR_D_MTU_U0_C7(uint16_t tgr_d_val)
*
* Function Name: R_PG_Timer_SetTGR_D_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_SetTGR_D_MTU_U0_C7(uint16_t tgr_d_val)
{
	R_MTU3_ControlChannel_structure parameters;
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_GetRequestFlag_MTU_U0_C7(bool * cm_ic_a, bool * cm_ic_b, bool * cm_ic_c, bool * cm_ic_d, bool * cm_e, bool * cm_f, bool * ov, bool * un)
*
* Function Name: R_PG_Timer_GetRequestFlag_MTU_U0_C7
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_Timer_GetRequestFlag_MTU_U0_C7(bool * cm_ic_a, bool * cm_ic_b, bool * cm_ic_c, bool * cm_ic_d, bool * cm_e, bool * cm_f, bool * ov, bool * un)
{
	uint8_t data;
	bool res;
